...
def get_args(parser, eval=False):
    ...
    parser.add_argument('--dataset', type=str, choices=[
                        'mnist', 'cifar10', 'ag_news'], default='cifar10')
    ...
    model_name += f'.{args.num_scales}scale'
    model_name += f'.{args.mid_channels}mchan'
    model_name += f'.{args.num_blocks}block'
